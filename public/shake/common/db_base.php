...
class db_base
{
    ...
    public function incrBy($strKey,$value){
        $this->redis->incrBy($strKey,$value);
    }
    ...
    public function dataDelete($table,$where){
        return $this->db_mysql->delete($table,$where);
    }
    public function functionName($table,$field_info,$where_info) 
    {
        $this->db_mysql->update($table,$field_info,$where_info);
    }
